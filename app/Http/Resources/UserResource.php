...
class UserResource extends JsonResource
{
    ...
    private function menu_permission()
    {
        ...
        if ($user_role == "ceo" || $user_role == "vp" || $user_role == "presales_manager") {
            $menu = ['opportunities', 'products','travel', 'clients', 'branches', 'users', 'demos', 'reports'];
        } else if ($user_role == "executive_manager" || $user_role == "sales_manager" || $user_role == "country_manager") {
